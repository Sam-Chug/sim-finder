...
const CUSTOM_STYLE_SIMHEADS = {
    male: "./images/sim-faces/simface-m.png?v0.2.2k",
    female: "./images/sim-faces/simface-f.png?v0.2.2k",
    reagan: "./images/sim-faces/simface-rea.png?v0.2.2k",
    bear: "./images/sim-faces/simface-b.png?v0.2.2k"
};
const IMAGE_UNKNOWN_SIM = new Image().src = "./images/sim-faces/simface-u.png?v0.2.2k"
